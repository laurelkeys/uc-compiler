                            ...
                            if bool(expr):
                                ...
                                for succ in block.sucessors:
                                    if succ.label == target_false:
                                        ...
                                        break
                                block.sucessors = [
                                    suc for suc in block.sucessors if suc.label != target_false
                                ]
                            else:
                                ...
                                for succ in block.sucessors:
                                    if succ.label == target_true:
                                        ...
                                        break
                                block.sucessors = [
                                    suc for suc in block.sucessors if suc.label != target_true
                                ]
                            ## if not op.startswith("literal_"): print("to  :", block.instructions[i])
    ...
    def post_process_blocks(cfg: ControlFlowGraph):
        ...
        for entry in cfg.entries:
            ...
            for block, lines in to_kill.items():
                block.instructions = [
                    instr for line, instr in enumerate(block.instructions) if line not in lines
                ]
